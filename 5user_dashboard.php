  ...
  <body>
    ...
    <!-- Heading -->
     ...
     <div class=" pos" style="background-color:#95a5a6;" id="javascriptbgcolor"> 
      ...
      <h1 class="container text-left" id="javascriptcolor1"> User: <?php echo $fetch_info['name'] ?></h1>
      <div id="myDIV" class="Hello" align="center"  >
  <h1 class="" id="javascriptcolor2" style="font-size: 22px";>Welcome</h1>
</div>
...
<label class="switch">
  ...
  <span class="slider round"></span>
      ...
      <div class="topright"><a href="logout-user.php" class="btn btn-light btn-lg " role="button" aria-pressed="true"  onclick="myFunction()" >Logout</a></button></div>
...
<!-- Nav bar -->
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark nav justify-content-center" id="navi3">
     ...
     <!--  <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link " href="6view_our_projects.php" target="_blank">View Our Projects</a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link " href="setting.php" target="_blank">Setting</a>
      </li>
    </ul>
  </nav>
  ...
  <div class="container" id="contactus">
   ...
   <h1 class="container text-center">Contact Us  & Follow Us</h1>
